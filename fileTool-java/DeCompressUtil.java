...
public class DeCompressUtil {
    ...
    public static void unrar(String sourceRar,String destDir) throws Exception{
        ...
        try{
            a = new Archive(new File(sourceRar),null);
            FileHeader fh = a.nextFileHeader();
            while(fh!=null){
                if(!fh.isDirectory()){
                    //1 根据不同的操作系统拿到相应的 destDirName 和 destFileName
                    String compressFileName = fh.getFileNameString().trim();
                    compressFileName=System.currentTimeMillis()+"minson"+compressFileName.substring(compressFileName.indexOf("."));
                    System.out.println("==========xxxx=========="+compressFileName);
                    String destFileName = "";
                    String destDirName = "";
                    //非windows系统
